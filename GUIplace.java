...
*/
    ...
    public GUIplace(DataUser data, BagUser bag) {
       ...
       // new UserData()
        ...
        JButton catchButton_1 = new JButton("Wild");
        JButton catchButton_2 = new JButton("Sea");
    ...
    /*    JButton backButton = new JButton("Back");
        ...
        if(data.getPokeBall() <= 1 && bag.getItems().size() <= bag.getFullBag()){
            ...
            JOptionPane.showMessageDialog(youGet, "PokemonBall is Empty", "You Got it!", JOptionPane.INFORMATION_MESSAGE);
        ...
        catchButton_1.addActionListener( new ActionListener() {
            ...
            public void actionPerformed( ActionEvent catch_it ) {
                ...
                +"\n\n++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n", "You Got it!", JOptionPane.INFORMATION_MESSAGE);
