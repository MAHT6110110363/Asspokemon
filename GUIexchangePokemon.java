...
public class GUIexchangePokemon extends JFrame{
    ...
    public GUIexchangePokemon(DataUser data, BagUser bag) {
        ...
        JButton cButton = new JButton("Cmon x" + data.getCard_P4());
        ...
        sButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(data.getCard_P1() <= 1) {
                    ...
                    +"\n    Attack : "+bag.getPokedex().get(0).getStatusPokemon().getAttack()
        ...
        aButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(data.getCard_P2() <= 1){
                    ...
                    +"\n    Attack : "+bag.getPokedex().get(1).getStatusPokemon().getAttack()
        ...
        bButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(data.getCard_P3() <= 1) {
                    ...
                    +"\n    Attack : "+bag.getPokedex().get(2).getStatusPokemon().getAttack()
        ...
        cButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(data.getCard_P4() <= 1) {
                    ...
                    +"\n    Attack : "+bag.getPokedex().get(3).getStatusPokemon().getAttack()
